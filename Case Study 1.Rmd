...
apac_costs <- data.frame(
  Country = c("India", "Indonesia", "Malaysia", "New Zealand", "Philippines", "Thailand"),
  `2023` = c("14.6%", "12.4%", "16.7%", "12.2%", "18.2%", "9.2%"),
  `2024` = c("15.3%", "16.2%", "14.2%", "13.6%", "19.3%", "13.2%"),
  `2025` = c("17.0%", "19.4%", "15.9%", "16.0%", "18.3%", "14.5%")
)
...
# Build the table
kable(apac_costs,
      caption = "Table _. Global medical trends: healthcare benefit cost increases, 2023 – 2025 (gross) - (APAC markets with higher percentages than regional average in 2025 (projected)",
