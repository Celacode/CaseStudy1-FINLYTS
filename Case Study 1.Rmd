...
kable(poverty_data, col.names = c("Year", "Poverty Incidence"), align = "c", caption = "Table _. Poverty Incidences in the Philippines 2021 to 2024.") %>%
  kable_styling(full_width = FALSE, position = "center") %>%
  footnote(general = "Sources: Philippine Statistics Authority (2022 & 2024), Domingo (2022) - Inquirer.com, Philippine News Agency (2024).")
```
