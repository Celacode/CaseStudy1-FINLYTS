...
poverty_data <- data.frame(
  ...
  Source = c("Philippine Statistics Authority, 2022", "Domingo, 2022", "Philippine Statistics Authority, 2024", "Philippine News Agency, 2024"),
  Poverty_Incidence = c("18.1", "17.1 (Estimation)", "15.5", "13.6 (Estimation)")
)

kable(poverty_data, col.names = c("Year", "Source", "Poverty Incidence (%)"), align = "c", caption = "Table _. Poverty Incidences in the Philippines 2021 to 2024.") %>%
  kable_styling(full_width = FALSE, position = "center") %>%
  add_footnote("Sources: Philippine Statistics Authority (2022 & 2024), Domingo (2022) - Inquirer, Philippine News Agency (2024).", notation = "none")
```
...
kable(microfinance_data, col.names = c("Microfinance Institutions", "Number of Institutions"), caption = "Table _. Microfinance Institutions and their numbers in the Philippines") %>%
  kable_styling(full_width = FALSE, position = "center") %>%
  add_footnote("Source: Social Enterprise Development Partnerships, Inc., 2023", notation = "none")
```
...
kable(inflation_data, col.names = c("Month 2024", "Inflation Rate (%)"), digits = 1, caption = "Table _. Inflation Rate for the months of January, June, and July in 2024.") %>%
  kable_styling(full_width = FALSE, position = "center") %>%
